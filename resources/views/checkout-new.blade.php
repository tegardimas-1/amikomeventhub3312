        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <div class="flex gap-6 items-start">
                    <img src="{{ asset($event['image']) }}" alt="{{ $event['name'] }}" class="w-24 h-24 rounded-2xl object-cover">
                    <div>
                ...
                <form id="checkoutForm" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Nama
                            Lengkap</label>
                        <input type="text" name="name" placeholder="Masukkan nama sesuai identitas"
                    ...
                    <button type="button" id="payBtn"
                        ...
                        Bayar Sekarang - Rp {{ number_format($totalPrice, 0, ',', '.') }}
                    </button>
                ...
                if (data.success) {
                    ...
                    snap.pay(data.snap_token, {
                        onSuccess: function(result) {
                            window.location.href = '{{ route("checkout.finish") }}?status_code=' + result.status_code + '&order_id=' + result.order_id;
                        },

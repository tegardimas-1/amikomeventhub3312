...
@section('page-subtitle', 'Buat kategori baru untuk mengorganisir event.')
...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            <h2 class="text-2xl font-black mb-8">Informasi Kategori</h2>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="5" 
                        ...
                        placeholder="Jelaskan jenis kategori ini...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
